...
# Data Transforms
##################################
# For MNIST-like images, typical normalization is mean=0.1307, std=0.3081.
data_transform = transforms.Compose([
    transforms.Grayscale(num_output_channels=1),  # In case images are RGB
    transforms.Resize((28, 28)),                  # Ensure 28×28
    transforms.ToTensor(),
...
# Load MNIST Dataset
##################################
# Using augmented transforms only on the original MNIST data for variety
...
##################################
# Points to a folder structure "generated_dataset/0", "generated_dataset/1", etc.
